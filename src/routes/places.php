 ...
 * Front office routes
 */
ModuleRoutes::group('places', function (Router $router): void {
    $router->get('/', [PublicController::class, 'index']);
    $router->get('places-json', [JsonController::class, 'index']);
    $router->get('{place}', [PublicController::class, 'show']);
    $router->get('{place}/json', [JsonController::class, 'show']);
});
